...
# generated by {{ ref $plugin }} {{ $plugin->VERSION() }}
...
=head2 xt/lib/Local/TestsDirs.pm

A small helper library that is used to find the correct path to the xt
directory, depending on if the test is run with prove in the repository
or with Author::SKIRMESS::RunExtraTests::FromRepository in the distribution.

=cut

    $file{q{xt/lib/Local/TestsDirs.pm}} = <<'XT_LIB_LOCAL_TESTSDIRS_PM';
